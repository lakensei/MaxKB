...
from setting.models_provider.impl.openai_model_provider.credential.vlm import OpenAIVLMModelCredential
...
openai_vlm_model_credential = OpenAIVLMModelCredential()
model_info_list = [
    ModelInfo('cogvlm2', '本地部署开源视觉语言模型', ModelTypeConst.VLM,
              openai_vlm_model_credential, OpenAIChatModel
              ),
