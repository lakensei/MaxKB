...
from common.handle.impl.ppt_split_handle import PPTSplitHandle
...
split_handles = [HTMLSplitHandle(), DocSplitHandle(), PdfSplitHandle(), PPTSplitHandle(), default_split_handle]
